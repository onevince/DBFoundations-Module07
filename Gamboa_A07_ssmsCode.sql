...
-- 2017-01-01,GamboaV,Created File
--**************************************************************************--
Begin Try
	Use Master;
	If Exists(Select Name From SysDatabases Where Name = 'Assignment07DB_GamboaV')
	 Begin 
	  Alter Database [Assignment07DB_GamboaV] set Single_user With Rollback Immediate;
	  Drop Database Assignment07DB_GamboaV;
	 End
	Create Database Assignment07DB_GamboaV;
End Try
Begin Catch
	Print Error_Number();
End Catch
go
Use Assignment07DB_GamboaV;
...
From vCategories as C
	...
	Inner join vInventories as I
		On P.ProductID = I.ProductID
Group by C.CategoryName, Format(I.InventoryDate, 'MMMM, yyyy')
Order by C.CategoryName, Format(I.InventoryDate, 'MMMM, yyyy'), InventoryCountByCategory;
go
